...
To install [Feather](http://github.com/khcrysalis/Feather/) we'll be using [KravaSigner](https://sign.kravasign.com/). To begin, open the [KravaSigner](https://sign.kravasign.com/) website below.
