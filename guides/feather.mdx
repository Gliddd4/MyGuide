...
To install Feather on your iDevice you can use KravaSigner, a unaffialted website that allows you to import your certificate for the purpose of installing .ipa files.
